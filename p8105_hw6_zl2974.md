...
 The r^2 follows a left-tailed distribution, as showed in the scatter
plot, tmax and tmin is strongly linear associated at a glance. As such,
their linear models’ r^2 should be concentrated in the right side of the
support regardless central limit theorem.
